<template>
  <div class="home">
    <el-card shadow="never" style="margin-block: 1rem; width: 97%;margin-left:1rem">
      ...
      <el-col :span="15">
        <div class="home-left">
          ...
          <div
            ...
            style="width: 15rem"
          >
            <el-card :body-style="{ padding: '1px' }" shadow="hover" @click="GotoFoodview(index.index)">
              <el-row :gutter="0">
                <el-col :span="19">
                  <el-progress
                    :width="85"
